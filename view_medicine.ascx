<%@ Control Language="C#" AutoEventWireup="true" CodeFile="view_medicine.ascx.cs" Inherits="view_medicine" %>
        ...
        <asp:Label ID="Label1" runat="server" Text='<%#Eval("product_name")%>' Font-Size="Medium"></asp:Label>
           ...
           <tr>
               ...
               <center>
                ...
                <td>
              <center>
                   <a href="gen_req.aspx?id=<%#DataBinder.Eval(Container.DataItem,"product_code") %>">request</a>
                 </center>
                </td>
                </tr>
