<%@ Control Language="C#" AutoEventWireup="true" CodeFile="view_chem_request1.ascx.cs" Inherits="view_chem_request1" %>
  ...
  <form method="post" action="">
					      ...
					      <div>
                             ...
                             <div>
						    	...
						    	<span><asp:TextBox ID="TextBox8" runat="server" class="sam" ReadOnly></asp:TextBox></span>
						    </div>
						    <div>
